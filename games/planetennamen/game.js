...
const bodies = [
  {
    ...
    info: {
      de: {
        ...
        facts: [["Nähe", "Sonne"], ["Oberfläche", "felsig"], ["Ein Jahr", "88 Erdentage"], ["Besonders", "starke Temperaturunterschiede"]],
      ...
      sk: {
        ...
        facts: [["Blízko", "Slnka"], ["Povrch", "skalnatý"], ["Jeden rok", "88 pozemských dní"], ["Zaujímavosť", "veľké rozdiely teplôt"]],
  ...
  },
  {
    ...
    info: {
      de: {
        ...
        facts: [["Nachbar", "Erde"], ["Wolken", "sehr dicht"], ["Ein Tag", "länger als ein Jahr"], ["Besonders", "heißester Planet"]],
      ...
      sk: {
        ...
        facts: [["Sused", "Zem"], ["Oblaky", "veľmi husté"], ["Jeden deň", "dlhší ako rok"], ["Zaujímavosť", "najhorúcejšia planéta"]],
  ...
  },
  {
    ...
    info: {
      de: {
        ...
        facts: [["Gehört zu", "Erde"], ["Oberfläche", "Krater und Staub"], ["Umlauf", "etwa 27 Tage"], ["Besonders", "besucht von Menschen"]],
      ...
      sk: {
        ...
        facts: [["Patrí k", "Zemi"], ["Povrch", "krátery a prach"], ["Obeh", "asi 27 dní"], ["Zaujímavosť", "navštívili ho ľudia"]],
  ...
  },
  {
    ...
    info: {
      de: {
        ...
        facts: [["Monde", "2"], ["Farbe", "rot-orange"], ["Ein Jahr", "687 Erdentage"], ["Besonders", "Olympus Mons"]],
      ...
      sk: {
        ...
        facts: [["Mesiace", "2"], ["Farba", "červeno-oranžová"], ["Jeden rok", "687 pozemských dní"], ["Zaujímavosť", "Olympus Mons"]],
  ...
  },
  {
    ...
    info: {
      de: {
        ...
        facts: [["Art", "Gasriese"], ["Monde", "sehr viele"], ["Ein Jahr", "etwa 12 Erdjahre"], ["Besonders", "Großer Roter Fleck"]],
      ...
      sk: {
        ...
        facts: [["Druh", "plynný obor"], ["Mesiace", "veľmi veľa"], ["Jeden rok", "asi 12 pozemských rokov"], ["Zaujímavosť", "Veľká červená škvrna"]],
  ...
  },
  {
    ...
    info: {
      de: {
        ...
        facts: [["Art", "Gasriese"], ["Ringe", "sehr groß"], ["Ein Jahr", "etwa 29 Erdjahre"], ["Besonders", "auffälliges Ringsystem"]],
      ...
      sk: {
        ...
        facts: [["Druh", "plynný obor"], ["Prstence", "veľmi veľké"], ["Jeden rok", "asi 29 pozemských rokov"], ["Zaujímavosť", "výrazné prstence"]],
...
function renderSystem() {
  ...
  for (const body of bodies) {
    ...
    button.setAttribute("aria-label", `${body.name} anzeigen`);
